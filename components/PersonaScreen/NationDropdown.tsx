...
const DropdownGroup: React.FC<DropdownProps> = ({ options }) => (
    <select className='popUpSelectWithoutImage border w-full bg-transparent shadow-none noShodow rounded-[5px] px-[18px] h-[30px] text-[12px] font-[600] outline-none -mt-2' >
