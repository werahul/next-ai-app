...
const dropdownOptions: Option[][] = [
    [
        { value: 'Select Nation', label: 'Select Nation' },
...
const DropdownGroup: React.FC<DropdownProps> = ({ options }) => (
    <select className='popUpSelectWithoutImage border w-[360px] bg-transparent shadow-none noShodow rounded-[5px] px-[18px] h-[30px] text-[12px] font-[600] outline-none -mt-2' >
...
const NationDropdownFillter: React.FC = () => (
    <div className="">
...
export default NationDropdownFillter;