...
const Page = () => {
  ...
  const items = [
    ...
    { id: 5, name: 'Wizardlm', type: 'Chat', modelImg: "/model2.svg" },
    { id: 6, name: 'Mistral', type: 'Chat', modelImg: "/model4.svg" },
              ...
              <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
                <div className="bg-white w-[569px] h-[261px] popup-content">
                  <div className="p-5 space-y-3">
                    ...
                    <button
                      type="submit"
                      className="buttonBg w-[100%] h-[56px]  rounded-[8px] text-[14px] text-white font-bold"
